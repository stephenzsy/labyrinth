(function () {
    ...
    app.controller('adminPackagesController', function ($scope, $window, $AdminPackages) {
    ...
    app.controller('adminPackageController', function ($scope, $route, $AdminPackages) {
        $scope.packageId = $route.current.params.packageId;
    });

    app.service('$AdminPackages', function ($http) {
        return {
